...
$ekomi->createProduct("00001", "Produktname #1");

$ekomi->createProduct("00002", "Produktname #2");

$ekomi->createProduct("00003", "Produktname #3");

echo $ekomi->generateLink("3298748a");

echo $ekomi->generateLink("3298748b", ["00001", "00002", "00003"]);